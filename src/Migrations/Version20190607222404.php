 ...
 */
final class Version20190607222404 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, question VARCHAR(255) NOT NULL, answer LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE result (id INT AUTO_INCREMENT NOT NULL, resultat INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE result_user (result_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_1DA8CD077A7B643 (result_id), INDEX IDX_1DA8CD07A76ED395 (user_id), PRIMARY KEY(result_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE result_quiz (result_id INT NOT NULL, quiz_id INT NOT NULL, INDEX IDX_3429E1DC7A7B643 (result_id), INDEX IDX_3429E1DC853CD175 (quiz_id), PRIMARY KEY(result_id, quiz_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE result_quiz DROP FOREIGN KEY FK_3429E1DC853CD175');
        $this->addSql('ALTER TABLE result_user DROP FOREIGN KEY FK_1DA8CD077A7B643');
        $this->addSql('ALTER TABLE result_quiz DROP FOREIGN KEY FK_3429E1DC7A7B643');
        $this->addSql('ALTER TABLE result_user DROP FOREIGN KEY FK_1DA8CD07A76ED395');
